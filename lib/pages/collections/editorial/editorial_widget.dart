...
import 'editorial_model.dart';
export 'editorial_model.dart';

class EditorialWidget extends StatefulWidget {
  const EditorialWidget({super.key});

  @override
  State<EditorialWidget> createState() => _EditorialWidgetState();
}

class _EditorialWidgetState extends State<EditorialWidget> {
  late EditorialModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditorialModel());
  }
