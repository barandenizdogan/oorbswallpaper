...
import 'petricor_model.dart';
export 'petricor_model.dart';

class PetricorWidget extends StatefulWidget {
  const PetricorWidget({super.key});

  @override
  State<PetricorWidget> createState() => _PetricorWidgetState();
}

class _PetricorWidgetState extends State<PetricorWidget> {
  late PetricorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PetricorModel());
  }
