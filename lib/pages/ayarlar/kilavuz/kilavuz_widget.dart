...
import 'kilavuz_model.dart';
export 'kilavuz_model.dart';

class KilavuzWidget extends StatefulWidget {
  const KilavuzWidget({super.key});

  @override
  State<KilavuzWidget> createState() => _KilavuzWidgetState();
}

class _KilavuzWidgetState extends State<KilavuzWidget> {
  late KilavuzModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KilavuzModel());
  }
